...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        const d = o1[0]*o2[0] + o1[1]*o2[1] + o1[2]*o2[2];
        return d;
    }
    ...
    static cross(other1, other2) {
        const o1 = other1.elements;
        const o2 = other2.elements;
        const cx = o1[1]*o2[2] - o1[2]*o2[1];
        const cy = o1[2]*o2[0] - o1[0]*o2[2];
        const cz = o1[0]*o2[1] - o1[1]*o2[0];
        const v3 = new Vector3([cx, cy, cz]);
        return v3;
    }
